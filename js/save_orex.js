...
const SAVE_HELP_DESCRIPTIONS = [
    ...
    { name: "filename_prefix_1", label: "Prefix 1 / Префикс имени 1", desc: "First block of the filename", ru_desc: "Первый блок в названии файла" },
    ...
    // Связано с новым системным именем quality_jpg_webp
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name !== "orex Save Image") return;
